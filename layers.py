...
class FeatureExtractor(nn.Module):
    ...
    def save_outputs_hook(self):
        def fn(module, input, output):
            ...
            # module에 V라는 속성이 있다면 저장합니다.
            self._V = module.V if hasattr(module, 'V') else None
    ...
    def forward(self, x):
        try:
            ...
            # loss가 있다면 반환하고, 없다면 None 반환
            return self._features, self._V, outputs.get("loss", None)
        except Exception as E:
            return self._features, self._V
